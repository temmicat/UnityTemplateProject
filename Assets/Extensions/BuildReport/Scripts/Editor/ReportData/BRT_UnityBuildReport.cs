...
namespace BuildReportTool
{
	...
	/// It works, but only <see cref="UnityEditor.Build.Reporting.BuildReport.name"/> and <see cref="UnityEditor.Build.Reporting.BuildReport.hideFlags"/> get serialized. The actual important generationData doesn't get saved.<br/>
