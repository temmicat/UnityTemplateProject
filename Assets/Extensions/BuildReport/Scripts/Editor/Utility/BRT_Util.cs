...
namespace BuildReportTool
{
	public static class Util
	{
		...
		public static BuildReportTool.BuildInfo OpenSerializedBuildInfo(string serializedBuildInfoFilePath, bool fromMainThread = true)
		{
			...
			try
			{
				// when the string has contents, it means there were corrections to the xml generationData
			...
			if (fromMainThread)
			{
				...
				{
					Debug.LogError("Build Report Tool: Invalid generationData in build info file: " + serializedBuildInfoFilePath);
				}
			}
