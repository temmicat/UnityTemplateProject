...
namespace FuguFirecracker.TakeNote
{
    internal static class Style
    {
        ...
        {
            wordWrap = true, 
            padding = new RectOffset(4, 0, 4, 0), alignment = TextAnchor.MiddleLeft,
            normal = {textColor = Color.white}
        };
        ...
        internal static readonly GUIStyle ExampleStyle = new GUIStyle
        {
            border = new RectOffset(2, 2, 2, 2),
            padding = new RectOffset(8, 2, 2, 2),
            margin = new RectOffset(2, 2, 2, 2),
            normal = {background = Ikon.Background, textColor = Color.white},
